...
class Audio2Face384(nn.Module):
    def __init__(self, input_dim=9):
        super(Audio2Face384, self).__init__()

        self.face_encoder_blocks = nn.ModuleList([
            nn.Sequential(Conv2d(input_dim, 24, kernel_size=7, stride=1, padding=3)),  # 384,384

            nn.Sequential(Conv2d(24, 32, kernel_size=3, stride=2, padding=1),  # 192,192
                          Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True),
                          Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True)),

            nn.Sequential(Conv2d(32, 64, kernel_size=3, stride=2, padding=1),  # 96,96
                          Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True),
                          Conv2d(64, 64, kernel_size=3, stride=1, padding=1, residual=True)),

            nn.Sequential(Conv2d(64, 128, kernel_size=3, stride=2, padding=1),  # 48,48
                          Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True),
                          Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True)),

            nn.Sequential(Conv2d(128, 256, kernel_size=3, stride=2, padding=1),  # 24,24
                          Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True),
                          Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True)),

            nn.Sequential(Conv2d(256, 256, kernel_size=3, stride=2, padding=1),  # 12,12
                          Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True),
                          Conv2d(256, 256, kernel_size=3, stride=1, padding=1, residual=True)),
        ...
        self.face_decoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(Conv2dTranspose(1536, 512, kernel_size=3, stride=2, padding=1, output_padding=1),
                          Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True),
            ...
            nn.Sequential(Conv2dTranspose(96, 32, kernel_size=3, stride=2, padding=1, output_padding=1),
                          Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True),
                          Conv2d(32, 32, kernel_size=3, stride=1, padding=1, residual=True), ), ])  # 192, 192

        self.output_block = nn.Sequential(Conv2d(56, 32, kernel_size=3, stride=1, padding=1),
                                          nn.Conv2d(32, 9, kernel_size=1, stride=1, padding=0),
                                          nn.Sigmoid())
